...
function rootPrerender(){
  ...
  return `<main class="page home-page seo-prerender"><section class="home-hero"><div class="home-hero-main"><div class="home-hero-copy"><span class="home-hero-kicker">Prévision multi-modèles</span><h1>Comparez les modèles. Repérez l’accord. Comprenez l’incertitude.</h1><p>MeteoCompare rassemble plusieurs prévisions pour faire ressortir ce qui converge, ce qui diverge et ce qui mérite votre attention dans vos villes.</p><div class="home-hero-pill-row"><span>Plusieurs modèles</span><span>Convergences</span><span>Divergences</span></div></div><aside class="forecast-expertise-disclaimer" role="note" aria-labelledby="seo-forecast-expertise-title"><span class="forecast-expertise-disclaimer-icon" aria-hidden="true">i</span><div><strong id="seo-forecast-expertise-title">Une aide à l’interprétation, jamais un substitut à l’expertise</strong><p>MeteoCompare met en évidence les convergences et divergences de prévisions multi-modèles pour mieux lire l’incertitude. Cette synthèse reste indicative et ne remplacera jamais l’expertise humaine d’un météorologue ou d’un professionnel compétent.</p></div></aside></div><aside class="home-hero-side"><div class="home-hero-search-panel"><strong>Explorez une prévision comparée</strong><p>Choisissez une ville ci-dessous pour confronter les modèles, leurs écarts et leur évolution.</p></div></aside></section><section class="section-card seo-prerender-copy"><div class="section-head"><div><h2>Une prévision météo qui montre aussi l’incertitude</h2><p>Consultez la température, la pluie et le vent, puis comparez la dispersion entre modèles et leur convergence. Les prévisions actualisées se chargent dans votre navigateur.</p></div></div></section><section class="seo-directory"><div class="home-section-heading home-column-heading seo-directory-heading"><div><span class="home-section-kicker">Explorer</span><h2>Prévisions météo par ville</h2></div></div><div class="section-card seo-directory-card"><p class="seo-directory-intro">Accédez directement aux comparaisons multi-modèles des principales villes françaises.</p><div class="seo-link-grid">${links}</div></div></section></main>`;
}
