...
// Server-only modules are bundled by Wrangler/used by tooling; they are not public PWA assets.
await rm(join(out,'js','server'),{recursive:true,force:true});
