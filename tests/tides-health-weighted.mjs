...
assert.ok(sw.includes("v30-tides-health-weighted"));assert.ok(html.includes('openmeteo-data-spatial.b-cdn.net'));assert.ok(storage.includes('meteocompare.web.health.'));
