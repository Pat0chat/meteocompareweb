...
assert.match(css,/\.marine-tide-layout\s*\{[^}]*grid-template-columns:\s*minmax\(0,1fr\)/s,'tide chart occupies the full workspace width');
...
console.log('tests/marine/regression/styles.tide-table-alignment.test.mjs: OK');
