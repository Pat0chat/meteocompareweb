...
assert.match(sw,/v18-evolution-reliability-icon/,'PWA shell cache was bumped');
...
assert.match(workflow,/pwa-about-legends\.mjs/,'GitHub Pages workflow runs the PWA/About/legends regression suite');
