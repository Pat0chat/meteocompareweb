...
assert.match(sw,/const APP_VERSION = '1\.10\.6'/);
assert.match(sw,/const CACHE_VERSION = 'v36-play-store-nav'/);
console.log('MeteoCompare Web 1.10.6 Play Store navigation: OK');
