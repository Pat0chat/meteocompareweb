...
assert.match(sw,/const APP_VERSION = '1\.9\.0'/);assert.match(sw,/const CACHE_VERSION = 'v29-production-foundation'/);assert.match(sw,/features\/marine\.js/);
...
console.log('MeteoCompare v1.9 production foundation tests: OK');
