...
const bootstrap=fs.readFileSync(new URL('../../../js/analytics-transport.js',import.meta.url),'utf8');
assert.doesNotMatch(html,/<script[^>]+src=["']\/?_mcx\/p\.js/,'no third-party tracker script should be loaded');
...
console.log('MeteoCompare local preview internal analytics isolation: OK');
