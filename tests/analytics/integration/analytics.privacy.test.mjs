...
client.setOptOut(false); assert.equal(client.status().active,true);assert.equal(reconcileCalls,2,'analytics opt-out changes must reconcile the first-party analytics transport lifecycle');
