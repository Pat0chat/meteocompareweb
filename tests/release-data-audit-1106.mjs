...
assert.equal(releaseVersion,'1.10.6');
assert.match(swSource,/const APP_VERSION = '1\.10\.6'/);
assert.match(swSource,/const CACHE_VERSION = 'v36-play-store-nav'/);

console.log('MeteoCompare Web 1.10.6 release data-chain audit: OK');
