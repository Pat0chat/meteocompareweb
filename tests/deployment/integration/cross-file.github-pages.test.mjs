...
assert.match(app,/serviceWorker\.register\(appAssetUrl\('sw\.js'\),\{scope:rootPath,updateViaCache:'none'\}\)/,'service worker registration must resolve from the module-derived repository root');
