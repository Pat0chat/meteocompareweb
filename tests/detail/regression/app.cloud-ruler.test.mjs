...
assert.match(css,/\.home-weather-facts \{[^}]*grid-template-columns:repeat\(2,minmax\(0,1fr\)\);[^}]*gap:6px;/s);
assert.match(css,/\.home-weather-fact \{[^}]*grid-template-columns:28px minmax\(0,1fr\);[^}]*border-radius:var\(--radius-sm\);/s);
...
console.log('tests/detail/regression/app.cloud-ruler.test.mjs: OK');
