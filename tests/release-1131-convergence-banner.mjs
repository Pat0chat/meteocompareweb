...
assert.equal(version,'1.13.1','application version must stay unchanged');
...
assert.match(sw,/CACHE_VERSION = 'v68-convergence-banner-stack'/,'PWA cache must refresh changed CSS/JS');
