...
function handleAction(e){
  ...
  else if(action==='refresh-system-monitor'){void trackAnalyticsEvent('System Monitor Refreshed',state.route);if(globalThis.__METEOCOMPARE_ANALYTICS_RUNTIME__?.state==='error'&&globalThis.__METEOCOMPARE_ANALYTICS_RUNTIME__?.lastDeliveryError==='script')globalThis.__METEOCOMPARE_ANALYTICS_CONTROL__?.retry?.();void probeSystemHealth(true);}
