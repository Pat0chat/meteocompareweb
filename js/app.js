...
function handleAction(e){
  ...
  else if(action==='refresh-model-health'){const id=state.route.id;if(id){void trackAnalyticsEvent('Model Health Refreshed',state.route);void refreshModelHealthData(id,true,true);}}
  ...
  else if(action==='toggle-diagnostics'){const id=state.route.id;if(!id)return;if(state.diagnosticsOpen.has(id))state.diagnosticsOpen.delete(id);else{state.diagnosticsOpen.add(id);void trackAnalyticsEvent('Diagnostics Opened',state.route);}rerenderCitySectionOrPage('diagnostics');}
