const DEFAULTS={
  ...
  NO_USABLE_MODELS:{severity:'error',titleKey:'errorNoModelsTitle',messageKey:'noUsableModels',actions:['retry','settings']},
  ...
  PARTIAL_MODELS:{severity:'warning',titleKey:'errorPartialModelsTitle',messageKey:'errorPartialModelsBody',actions:['retry']},
